...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-primary text-primary-foreground pt-12 pb-6 mt-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="flex flex-col items-start gap-3">
            <div className="flex items-center space-x-3 mb-2">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-primary-foreground/80">Premier Marine Engine Distributor</p>
              </div>
            </div>
            <p className="text-sm text-primary-foreground/90 max-w-xs font-medium">
            ...
            <div className="flex items-center gap-2 mt-2">
              <span className="text-accent text-sm font-semibold">24/7 Technical Support Available</span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-2">
              ...
              <ul className="text-sm text-primary-foreground/90 mt-1 space-y-1">
        ...
        <div className="border-t border-primary/20 mt-10 pt-6 flex flex-col md:flex-row md:justify-between md:items-center gap-4 text-xs text-primary-foreground/80">
          <div>
            © 2024 Laborde Products. All rights reserved.
          </div>
          <div className="flex items-center gap-2">
            <span className="text-accent">● Voice Ready</span>
